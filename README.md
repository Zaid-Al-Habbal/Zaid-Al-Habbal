...
| 🌕 [**Apollo 11 Simulation**](https://github.com/Zaid-Al-Habbal/apollo-11-simulation) · [🚀 Live Demo](https://zaid-al-habbal.github.io/apollo-11-simulation/)<br>`TypeScript` `Three.js` `Vite` | Physics-based 3D orbital mechanics simulator of the Apollo 11 mission — Earth-to-Moon transfer via Newtonian gravitation with RK4 and Velocity Verlet integration, orbital trails and cinematic burn effects | ⭐ 10 on GitHub |
| 🏙️ [**Cham City 3D**](https://github.com/Zaid-Al-Habbal/cham-city-3D)<br>`C++` `OpenGL` `CMake` | Open-source 3D simulation of Cham City Center in Damascus — modern OpenGL pipeline with shaders, reflections, MSAA, instancing, cubemaps, 3D audio and day/night mode | ⭐ 31 on GitHub |

<details>
<summary>📂 <b>More projects</b></summary>
<br>

- 💊 [**Oxytocin**](https://github.com/Zaid-Al-Habbal/oxytocin) — Django REST medical platform for Syria: appointments, medical records, clinic reviews & ratings; SMS notifications, map services, RBAC; containerized with Docker, Celery & PostgreSQL
- 📈 [**Stock Trends Predictor**](https://github.com/Zaid-Al-Habbal/stock-trends-predictor) — LSTM classifier for 30-day stock trend direction; reproducible Optuna hyperparameter sweeps with persistent SQLite storage
- 🎬 [**Movies Reviews Analyzer**](https://github.com/Zaid-Al-Habbal/movies-reviews-analyzer) — IMDb sentiment analysis; compared BPE, BBPE, WordPiece & Unigram tokenizers; GRU vs pretrained-embedding vs BERT variants
- 🌋 [**Lava & Aqua**](https://github.com/Zaid-Al-Habbal/lava-and-aqua) — puzzle game engine with clean OOP state management and classical AI search solvers (DFS, UCS, A*)
- 🪶 [**Shakespeare Text Generator**](https://github.com/Zaid-Al-Habbal/shakespeare-text-generator) — character-level RNN for generating Shakespearean text in PyTorch
- 🌐 [**English→Spanish Translator**](https://github.com/Zaid-Al-Habbal/english-to-spanish-translator) — sequence modeling experiments for machine translation
...
<p align="center">
  <b>Codeforces Specialist (1400+)</b> · 1000+ problems solved · <b>3× ICPC</b> participant — <b>11th place</b> at DCPC
</p>
...
- 🤖 [**Machine Learning Specialization**](https://coursera.org/share/fe297ef2f167de50a26b54fb6548e757) — DeepLearning.AI & Stanford Online
