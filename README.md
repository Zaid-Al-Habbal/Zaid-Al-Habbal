...
| 🏙️ [**Cham City 3D**](https://github.com/Zaid-Al-Habbal/cham-city-3D)<br>`C++` `OpenGL` `CMake` | Open-source 3D simulation of Cham City Center in Damascus — modern OpenGL pipeline with shaders, reflections, MSAA, instancing, cubemaps, 3D audio and day/night mode | ⭐ +30 on GitHub |
